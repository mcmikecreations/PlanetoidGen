...
{
    internal class HouseSeeder : IBuildingSeeder
    {
        private const double LengthMax = 3.0;

        private readonly ILogger _logger;
        private readonly JsonSerializerOptions _serializerOptions;
        private readonly string _title;

        public HouseSeeder(ILogger logger, JsonSerializerOptions serializerOptions, string title)
        {
            _logger = logger;
                            ...
                            for (var j = 0; j < levels.Value; ++j)
                            {
                                ...
                                for (var i = 0; i < sideCount; ++i)
                                {
                                    var parts = Enumerable
                                        ...
                                        .Select(y =>
                                        {
                                            int partRnd = random.NextInt(0, j == 0 ? 2 : 3);
