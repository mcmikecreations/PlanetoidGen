...
{
    public class AnonymousTypeRowSerializer<TData> : IRowSerializer<TData>
    {
        ...
        public AnonymousTypeRowSerializer(TableSchema schema, Func<IDataReader, TData>? deserializer = null)
        {
            _schema = schema;
        ...
        private Type GetAnonymousType(IEnumerable<string> keys, IEnumerable<Type> values)
        {
            ...
            var type = AnonymousType.CreateType(types, names);
